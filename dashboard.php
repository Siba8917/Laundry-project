    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li><a href="status.php" class="active"><span class=" fa  fa-folder"></span><span>Request Status</span></a></li> 
            </ul>
        </div>
    </div>
    <div class="content">
        <header >
            ...
            <p><label for="menu"><span class="fa fa-bars"></span></label><span class="dashboard">Dashboard/Overview</span>  </p>
                            ...
                            <div class="body-case"> 
                                <div class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Other Price</td>
                                            <td>Depend upon Cloth Veriety</td>
                                        </tr>
                                    </tbody>
                                    </table>
                                </div>
